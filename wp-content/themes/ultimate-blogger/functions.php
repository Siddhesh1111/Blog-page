...
function ultimate_blogger_enqueue_styles() {
	$parent_style = 'ultimate-blogger-style'; // Style handle of parent theme.
...
function ultimate_blogger_remove_parent_function() {
	remove_action( 'admin_menu', 'ultimate_blogger_gettingstarted' );
	remove_action('admin_notices', 'ultimate_blogger_notice');
}

function ultimate_blogger_font_url() {
	$font_url      = '';
	$font_family   = array();
