...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>  
  <div class="layout2">   
    ...
    <?php if( get_theme_mod( 'multipurpose_blog_metafields_date',true) != '') { ?>
     <div class="date-box text-center mb-3"><i class="<?php echo esc_attr(get_theme_mod('multipurpose_blog_post_date_icon','far fa-calendar-alt')); ?> mr-2"></i><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></div>  
    <?php }?>
    <div class="box-image text-center mb-2">
      <?php 
    ...
    <div class="cat-box text-center mt-3">
